    ...
    <div class="form_block">
      <form id="completar_perfil" name="completar_perfil" method="post">
        ...
        <div class="field">
          ...
          pattern="[a-zA-Z ]{3,}"
          title="El apellido debe tener como mínimo 3 carácteres alfabéticos"
          >
        ...
        <div class="check_boxes">
            <div class="text_medium_center">
                ...
                <input type="checkbox" class="checkbox" id="politicas_privacidad" name="politicas_privacidad" value="TRUE" required/><a href="<?php echo $politica_privacidad; ?>" target="blank_"><span>Acepto la Política de Privacidad y Cookies.</span></a>
                <span class="checkmark"></span>
                </label>
                <?php
                }
                ...
                ?>
                <label class="container">
                <input type="checkbox" class="checkbox" id="terminos_condiciones" name="terminos_condiciones" value="TRUE" required/><a href="<?php echo $terminos_condiciones; ?>" target="blank_"><span>Acepto Términos y condiciones de la Página Web.</span></a>
                <span class="checkmark"></span>
                </label>
                <?php
                }
      ...
      if ($("#nombre") && $("#pais") && $("#apellido")) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (strs == "1") {
              jQuery('.msgAlert .txtMsg').html("Tu perfil se ha completado con exito. Serás redirigido");
              $("#loader").css("display", "none");
              setTimeout(function(){
