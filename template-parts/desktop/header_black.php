...
input.search_cont_form_btn.w-button:hover {
    background: url(https://uploads-ssl.webflow.com/6005e026c2e3b59c35e06719/60072340f7a1782076c7ac1b_loupe.svg), linear-gradient(58deg, #ff3206, #f47d30) !important;
    color: black
}
...
<div class="home_header">
  <a href="<?php echo home_url(); ?>" class="home_header_logo w-inline-block">
    <img
    src="<?php echo IMGURL ?>menu/logo.png"
    loading="lazy"
    alt=""
    class="image-3"
    />
    ...
    <div class="home_header_right_top">
      <div class="search_cont_header">
        <form method="get" action="<?php echo home_url(); ?>" role="search" class="search_cont_form">
          ...
          <input type="submit" value="" class="search_cont_form_btn w-button">
        </form>
      </div>
      <?php if ($loginUser == "true") { ?>
        <div class="name_user_black">HOLA <?php if ($nameUser!=' ') {echo $nameUser;}else {echo $current_user->user_login; }?></div>
      ...
      <?php } ?>
      <?php if (!$loginUser == "true") { ?>
        <div class="name_user_black">
          <a class ="estilo_ingresar" href="<?php echo home_url('ingreso'); ?>" style="color:white" >INGRESAR</a>
        </div>
    ...
    <div class="home_header_right_bottom">
      <ul role="list" class="header-right_menu">
        <li class="header_right_menu_el" style="border-left:0px;">
          <a href="<?php echo home_url('productos'); ?>" class="right_menu_el_link_black"><?php echo get_option('menu_productos'); ?></a>
        </li>
        <li class="header_right_menu_el">
          <a href="<?php echo home_url('tarjetas'); ?>" class="right_menu_el_link_black"><?php echo get_option('menu_categorias'); ?></a>
        </li>
        <li class="header_right_menu_el">
          <a href="<?php echo home_url('eventos'); ?>" class="right_menu_el_link_black"><?php echo get_option('menu_eventos'); ?></a>
        </li>
        <?php
        // if(get_bloginfo()!="Argentina") {
        ?>
        <li class="header_right_menu_el">
          <a href="<?php echo home_url('retos'); ?>" class="right_menu_el_link_black"><?php echo get_option('menu_retos'); ?></a>
        ...
        ?>
        <li class="header_right_menu_el">
          <a href="<?php echo home_url('lanzamientos'); ?>" class="right_menu_el_link_black"><?php echo get_option('menu_lanzamientos'); ?></a>
        </li>
        <?php
        }
        ?>
