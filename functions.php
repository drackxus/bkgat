  ...
  //     ), $atts ) );
    ...
    $form .= '<div class="form_block">
      <form name="loginform" id="loginform" action="/wp-login.php" method="post">
        ...
        <div class="field">
          <input type="password" class="form_login_input w-input" name="pwd" id="user_pass" placeholder="Contraseña" required />
...
add_action( 'pre_handle_404', function() {
    ...
    if(!is_admin()){
        if(!$wp_query->found_posts)
        {
            ...
            if($url_current == $url) {
                wp_redirect(home_url('wp-content/media/2021/09/Política-de-privacidad.pdf'));
                exit;
            }
