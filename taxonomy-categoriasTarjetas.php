   ...
   <div class="search_topics_cont" style="display:flex; ">
        <div data-hover="" data-delay="0" class="search_topics_drop w-dropdown">
            ...
            <nav class="search_topics_result w-dropdown-list">
              ...
              <a href="<?php echo esc_url( get_term_link( $term ) ) ?>" class="search_topics_result_el w-dropdown-link"><?php echo $term->name; ?></a><div class="content_cont_h1_line" style="margin:0px auto;"></div>
              <?php
              }
              ?>
            </nav>
    ...
    <div class="content_subcategories fullw">
        ...
        ?>
                <a href="<?php echo get_term_link($children); ?>" class="res_taxonomy">
                    <?php
                        $image_l = get_term_meta($children->term_id, 'img_categoria');
                    ?>
                    <img loading="lazy" src="<?php echo $image_1[0] ?>" />
                    <div class="tit_subcategory">
                        <h2 class="content_cont_h3 bottom_line pad topics_el_tit"><?php echo $children->name; ?></h2>
...
.search_topics_drop_toggle{
    border: 2px solid whitesmoke;
    z-index:2;
    }
.search_cont_form_btn.drop_btn{
	top: -4%;
    right: -3%;
    bottom: -4%;
}
...
<div style="display:flex; width:100%; margin-top:60px">
	<div class="content_cont_tit_h1" style="width:70%;" >
        <h1 class="" style=" margin-bottom:15px;font-size: 30px;"><?php $tax = $wp_query->get_queried_object(); echo $tax->name; ?></h1>
        <div class="content_cont_h1_line"></div>
    </div>
    
   <div class="search_topics_cont" style="display:flex;width: 32%; margin-top:25px;">
        <div data-hover="" data-delay="0" class="search_topics_drop w-dropdown">
        	<div class="search_topics_drop_toggle w-dropdown-toggle">
                <div class="search_cont_form_btn drop_btn"></div>
                <div class="search_topics_drop_txt">Selecciona un tema</div>
            ...
            <nav class="search_topics_result w-dropdown-list">
              ...
              foreach ( $terms as $term ) { ?>
              <a href="<?php echo esc_url( get_term_link( $term ) ) ?>" class="search_topics_result_el w-dropdown-link"><?php echo $term->name; ?></a><div class="content_cont_h1_line" style="margin:0px auto;
    height: 1px; "></div>
              <?php
              }
              ?>
        ...
        ?>
                <a href="<?php echo get_term_link($children); ?>" class="res_taxonomy">
                    <?php
                        $image_l = get_term_meta($children->term_id, 'img_categoria');
                    ?>
                    <img loading="lazy" src="<?php echo $image_l[0]; ?>" />
                    <div class="tit_subcategory">
                        <h2 class="content_cont_h3 bottom_line pad topics_el_tit"><?php echo $children->name; ?></h2>
                        <div class="content_cont_h3_line"></div>
                    </div>
