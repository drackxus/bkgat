...
function register()
{
	...
	if (!$nombre || !$email || !$pais) {
		...
		if (!is_wp_error($user_id)) {
            ...
            update_user_meta($user_id, 'email_consent', 0);
            update_user_meta($user_id, 'whatsapp_consent', 0);
			...
			<div class="slide">
				<div class="card">
					<div class="card_content" id="favorites">
						...
						?>
							<video autoplay muted loop playsinline poster="<?php echo get_post_meta($post->ID, 'poster', true); ?>" class="video_bg">
